...
public class MyClassLoaderDemo {
    ...
    private static class MyClassLoader extends ClassLoader {
        ...
        String getFileName(String className) {
            String fileName = "myClass/" + className.substring(className.lastIndexOf('.') + 1) + ".class";
            return fileName;
//            return "C:\\Users\\fraud\\Documents\\git\\otus_java_2022_09\\L10-byteCodes\\myClass\\ClassForLoading.class";
