...
import static ru.otus.core.web.server.utils.WebServerHelper.*;
...
class UsersWebServerImplTest {
    ...
    static void setUp() throws Exception {
        ...
        webServer = new UsersWebServerWithFilterBasedSecurity(WEB_SERVER_PORT, userAuthService, userDao, clientDao, gson, templateProcessor);
        webServer.start();
    }
